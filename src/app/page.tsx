...
export default function Home() {
  ...
  return (
    <div className="flex flex-row justify-center">
      <ul role="list" className="divide-y divide-gray-800 w-1/2">
        {people.map((person) => (
          <li key={person.email} className="flex justify-between gap-x-6 py-5 hover:bg-slate-900/50 hover:cursor-pointer">
            <div className="flex min-w-0 gap-x-4">
              <Image className="h-12 w-12 flex-none rounded-full bg-gray-800" src={person.imageUrl} alt="" />
